        ...
        <div class="card-body">
            <form method="post" action="{{ route('pages.update', $page->id) }}">
                ...
                <div class="form-group">
                    ...
                    <input id="inputTitle" type="text" name="name" placeholder="Enter name" value="{{ $page->name }}"
                        class="form-control">
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input id="slug" type="text" name="slug" placeholder="Enter slug" value="{{ $page->slug }}"
                        class="form-control">
                    @error('slug')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
