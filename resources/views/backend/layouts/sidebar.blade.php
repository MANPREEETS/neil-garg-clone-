<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin') }}">
        ...
        <div class="sidebar-brand-text mx-3">GE</div>
    </a>
    ...
    <!-- Reviews -->
    <li class="nav-item">
        <a class="nav-link" href="{{ route('testimonails.index') }}">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('getNewsletter') }}">
            <i class="fas fa-cog"></i>
            <span>Newsletter requests</span></a>
    </li>

    <li class="nav-item">
        <a class="nav-link" href="{{ route('getContactRequests') }}">
            <i class="fas fa-cog"></i>
