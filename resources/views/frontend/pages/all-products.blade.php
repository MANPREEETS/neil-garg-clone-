    ...
    <div class="container">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">{{ request()->has('search') ? 'Search' : 'All Products' }} </a></li>
        ...
        <div class="row">
            <div class="col-lg-12 main-content">
                        ...
                        <div class="toolbox-item toolbox-sort">
                            ...
                            <div class="select-custom">
                                <select name="sortBy" class="form-control" onchange="this.form.submit();">
                                    ...
                                    <option value="price-des" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='price-des') selected @endif>Price (High to Low)</option>
                                </select>
                            </div>
                            <!-- End .select-custom -->
                ...
                <div class="{{ count($products) == 0 ? 'd-block' : 'd-none' }} row" >
                                ...
                                <div class="product-details">
                                    <div class="category-wrap">
                                        <div class="category-list">
                                            <a href="{{ route('product-cat', ['slug' => $product->cat_info->slug]) }}" class="product-category">{{ $product->cat_info->title }}</a>
                                            {{-- <a href="javascript:void(0)" class="product-category">#</a> --}}
                                        </div>
                                    </div>
                ...
                <!-- End .row -->
                <input type="hidden" name="search" value="{{ request()->has('search') ? request()->input('search') : '' }}">
                <input type="hidden" name="cat_id" value="{{ request()->has('cat_id') ? request()->input('cat_id') : '' }}">
