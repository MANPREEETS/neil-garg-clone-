        ...
        var e,
            ...
            c = {
                ...
                initCollapsibleWidget: function() {
                    t(".sidebar-wrapper .widget-title").on("click", function(
                        t
                    ) {
                        setTimeout(function() {
                            c.stickySidebar();
                    ...
                    t('.owl-item [data-animation-name="splitRight"]').each(
                        ...
                        t(".owl-carousel.slide-animate").each(function() {
                            ...
                            t(this).on("translate.owl.carousel", function(e) {
                                ...
                                t(this).on("translated.owl.carousel", function(
                                    n
                                ) {
                                    var o = t(this);
                                    if (
                                        t(this).find(".owl-item.active")[0] !==
                                        i[0]
                                    ) {
                ...
                filterSlider: function() {
                    ...
                    null != e &&
                        (noUiSlider.create(e, {
                            start: [priceFlag ? minPrice : 0, priceFlag ? maxPrice : 20000],
                            connect: !0,
                            step: 200,
                            margin: 200,
                        ...
                        e.noUiSlider.on("update", function(e, i) {
                            // need to set the current value in the form also
                            $('#minPrice').val(e[0]);
                            $('#maxPrice').val(e[1]);
                            e = e.map(function(t) {
                                return "₹" + parseInt(t);
                ...
                popupMenu: function() {
                    if (!(t(".popup-menu").length <= 0)) {
                        ...
                        i >= 0 && e.css("margin-right", "-" + i + "px"),
                            ...
                            t("body").on("click", ".popup-menu-close", function(
                                e
                            ) {
