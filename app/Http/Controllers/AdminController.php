...
class AdminController extends Controller
{
    ...
    public function settingsUpdate(Request $request){
        ...
        $this->validate($request,[
            ...
            'contact_image_1'=>'nullable|string',
            'contact_image_2'=>'nullable|string',
        ]);
        $data=$request->all();
        // return $data;
    ...
    public function getNewsletter() {
        ...
        return view('backend.newsletters.index')->with('newsletters',$newsletters);
    }
    ...
    public function newsletterDelete($id) {
        ...
        if($status){
            request()->session()->flash('success','Newsletter successfully deleted');
        }
        else{
    ...
    public function getContactRequests() {
        $contacts = ContactRequest::paginate(10);
    ...
    public function contactDelete ($id) {
        ...
        if($status){
            request()->session()->flash('success','Contact request successfully deleted');
        }
        else{
            request()->session()->flash('error','Error while deleting testimonial');
        }
